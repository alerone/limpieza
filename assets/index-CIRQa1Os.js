 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const f=function(n,e){if(!n)throw Te(e)},Te=function(n){return new Error("Firebase Database ("+Zs.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vr(n){return ni(void 0,n)}function ni(n,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const t=e;return new Date(t.getTime());case Object:n===void 0&&(n={});break;case Array:n=[];break;default:return e}for(const t in e)!e.hasOwnProperty(t)||!$r(t)||(n[t]=ni(n[t],e[t]));return n}function $r(n){return n!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xr(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function ri(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Xr())}function Jr(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Zr(){return Zs.NODE_ADMIN===!0}function eo(){try{return typeof indexedDB=="object"}catch{return!1}}function to(){return new Promise((n,e)=>{try{let t=!0;const s="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(s);i.onsuccess=()=>{i.result.close(),t||self.indexedDB.deleteDatabase(s),n(!0)},i.onupgradeneeded=()=>{t=!1},i.onerror=()=>{var r;e(((r=i.error)===null||r===void 0?void 0:r.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const no="FirebaseError";class Ze extends Error{constructor(e,t,s){super(t),this.code=e,this.customData=s,this.name=no,Object.setPrototypeOf(this,Ze.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,oi.prototype.create)}}class oi{constructor(e,t,s){this.service=e,this.serviceName=t,this.errors=s}create(e,...t){const s=t[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?so(r,s):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new Ze(i,a,s)}}function so(n,e){return n.replace(io,(t,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const io=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ai=function(n){let e={},t={},s={},i="";try{const r=n.split(".");e=Ue(sn(r[0])||""),t=Ue(sn(r[1])||""),i=r[2],s=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:s,signature:i}},ro=function(n){const e=ai(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},oo=function(n){const e=ai(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var b;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(b||(b={}));const po={debug:b.DEBUG,verbose:b.VERBOSE,info:b.INFO,warn:b.WARN,error:b.ERROR,silent:b.SILENT},go=b.INFO,mo={[b.DEBUG]:"log",[b.VERBOSE]:"log",[b.INFO]:"info",[b.WARN]:"warn",[b.ERROR]:"error"},yo=(n,e,...t)=>{if(e<n.logLevel)return;const s=new Date().toISOString(),i=mo[e];if(i)console[i](`[${s}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class li{constructor(e){this.name=e,this._logLevel=go,this._logHandler=yo,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in b))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?po[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,b.DEBUG,...e),this._logHandler(this,b.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,b.VERBOSE,...e),this._logHandler(this,b.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,b.INFO,...e),this._logHandler(this,b.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,b.WARN,...e),this._logHandler(this,b.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,b.ERROR,...e),this._logHandler(this,b.ERROR,...e)}}const vo=(n,e)=>e.some(t=>n instanceof t);let cs,hs;function Co(){return cs||(cs=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Eo(){return hs||(hs=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const ci=new WeakMap,rn=new WeakMap,hi=new WeakMap,jt=new WeakMap,Tn=new WeakMap;function wo(n){const e=new Promise((t,s)=>{const i=()=>{n.removeEventListener("success",r),n.removeEventListener("error",o)},r=()=>{t(X(n.result)),i()},o=()=>{s(n.error),i()};n.addEventListener("success",r),n.addEventListener("error",o)});return e.then(t=>{t instanceof IDBCursor&&ci.set(t,n)}).catch(()=>{}),Tn.set(e,n),e}function Io(n){if(rn.has(n))return;const e=new Promise((t,s)=>{const i=()=>{n.removeEventListener("complete",r),n.removeEventListener("error",o),n.removeEventListener("abort",o)},r=()=>{t(),i()},o=()=>{s(n.error||new DOMException("AbortError","AbortError")),i()};n.addEventListener("complete",r),n.addEventListener("error",o),n.addEventListener("abort",o)});rn.set(n,e)}let on={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return rn.get(n);if(e==="objectStoreNames")return n.objectStoreNames||hi.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return X(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function bo(n){on=n(on)}function So(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const s=n.call(zt(this),e,...t);return hi.set(s,e.sort?e.sort():[e]),X(s)}:Eo().includes(n)?function(...e){return n.apply(zt(this),e),X(ci.get(this))}:function(...e){return X(n.apply(zt(this),e))}}function To(n){return typeof n=="function"?So(n):(n instanceof IDBTransaction&&Io(n),vo(n,Co())?new Proxy(n,on):n)}function X(n){if(n instanceof IDBRequest)return wo(n);if(jt.has(n))return jt.get(n);const e=To(n);return e!==n&&(jt.set(n,e),Tn.set(e,n)),e}const zt=n=>Tn.get(n);function No(n,e,{blocked:t,upgrade:s,blocking:i,terminated:r}={}){const o=indexedDB.open(n,e),a=X(o);return s&&o.addEventListener("upgradeneeded",l=>{s(X(o.result),l.oldVersion,l.newVersion,X(o.transaction),l)}),t&&o.addEventListener("blocked",l=>t(l.oldVersion,l.newVersion,l)),a.then(l=>{r&&l.addEventListener("close",()=>r()),i&&l.addEventListener("versionchange",c=>i(c.oldVersion,c.newVersion,c))}).catch(()=>{}),a}const Ro=["get","getKey","getAll","getAllKeys","count"],Ao=["put","add","delete","clear"],Yt=new Map;function us(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Yt.get(e))return Yt.get(e);const t=e.replace(/FromIndex$/,""),s=e!==t,i=Ao.includes(t);if(!(t in(s?IDBIndex:IDBObjectStore).prototype)||!(i||Ro.includes(t)))return;const r=async function(o,...a){const l=this.transaction(o,i?"readwrite":"readonly");let c=l.store;return s&&(c=c.index(a.shift())),(await Promise.all([c[t](...a),i&&l.done]))[0]};return Yt.set(e,r),r}bo(n=>({...n,get:(e,t,s)=>us(e,t)||n.get(e,t,s),has:(e,t)=>!!us(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ko{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Do(t)){const s=t.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(t=>t).join(" ")}}function Do(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const an="@firebase/app",ds="0.11.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ua=ia;function ui(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const s=Object.assign({name:ln,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw J.create("bad-app-name",{appName:String(i)});if(t||(t=ii()),!t)throw J.create("no-options");const r=pt.get(i);if(r){if(_t(t,r.options)&&_t(s,r.config))return r;throw J.create("duplicate-app",{appName:i})}const o=new _o(i);for(const l of cn.values())o.addComponent(l);const a=new ha(t,s,o);return pt.set(i,a),a}function da(n=ln){const e=pt.get(n);if(!e&&n===ln&&ii())return ui();if(!e)throw J.create("no-app",{appName:n});return e}function ve(n,e,t){var s;let i=(s=ra[n])!==null&&s!==void 0?s:n;t&&(i+=`-${t}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${i}" with version "${e}":`];r&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),j.warn(a.join(" "));return}gt(new He(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fa="firebase-heartbeat-database",_a=1,Ve="firebase-heartbeat-store";let Kt=null;function di(){return Kt||(Kt=No(fa,_a,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Ve)}catch(t){console.warn(t)}}}}).catch(n=>{throw J.create("idb-open",{originalErrorMessage:n.message})})),Kt}async function pa(n){try{const t=(await di()).transaction(Ve),s=await t.objectStore(Ve).get(fi(n));return await t.done,s}catch(e){if(e instanceof Ze)j.warn(e.message);else{const t=J.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});j.warn(t.message)}}}async function _s(n,e){try{const s=(await di()).transaction(Ve,"readwrite");await s.objectStore(Ve).put(e,fi(n)),await s.done}catch(t){if(t instanceof Ze)j.warn(t.message);else{const s=J.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});j.warn(s.message)}}}function fi(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ga=1024,ma=30;class ya{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new Ca(t),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=ps();if(((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(o=>o.date===r))return;if(this._heartbeatsCache.heartbeats.push({date:r,agent:i}),this._heartbeatsCache.heartbeats.length>ma){const o=Ea(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(o,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(s){j.warn(s)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=ps(),{heartbeatsToSend:s,unsentEntries:i}=va(this._heartbeatsCache.heartbeats),r=dt(JSON.stringify({version:2,heartbeats:s}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}catch(t){return j.warn(t),""}}}function ps(){return new Date().toISOString().substring(0,10)}function va(n,e=ga){const t=[];let s=n.slice();for(const i of n){const r=t.find(o=>o.agent===i.agent);if(r){if(r.dates.push(i.date),gs(t)>e){r.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),gs(t)>e){t.pop();break}s=s.slice(1)}return{heartbeatsToSend:t,unsentEntries:s}}class Ca{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return eo()?to().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await pa(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return _s(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return _s(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function gs(n){return dt(JSON.stringify({version:2,heartbeats:n})).length}function Ea(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let s=1;s<n.length;s++)n[s].date<t&&(t=n[s].date,e=s);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wa(n){gt(new He("platform-logger",e=>new ko(e),"PRIVATE")),gt(new He("heartbeat",e=>new ya(e),"PRIVATE")),ve(an,ds,n),ve(an,ds,"esm2017"),ve("fire-js","")}wa("");var Ia="firebase",ba="11.6.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ve(Ia,ba,"app");var ms={};const ys="@firebase/database",vs="1.0.14";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pi=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Ta(e)}}catch{}return new Na},ce=pi("localStorage"),Ra=pi("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const An="5",vi="v",Ci="s",Ei="r",wi="f",Ii=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,bi="ls",Si="p",un="ac",Ti="websocket",Ni="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qt={},Xt={};function kn(n){const e=n.toString();return Qt[e]||(Qt[e]=new Ga),Qt[e]}function qa(n,e){const t=n.toString();return Xt[t]||(Xt[t]=e()),Xt[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ws="start",za="close",Ya="pLPCommand",Ka="pRTLPCB",ki="id",Di="pw",Pi="ser",Qa="cb",Xa="seg",Ja="ts",Za="d",el="dframe",xi=1870,Oi=30,tl=xi-Oi,nl=25e3,sl=3e4;class ye{constructor(e,t,s,i,r,o,a){this.connId=e,this.repoInfo=t,this.applicationId=s,this.appCheckToken=i,this.authToken=r,this.transportSessionId=o,this.lastSessionId=a,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=tt(e),this.stats_=kn(t),this.urlFn=l=>(this.appCheckToken&&(l[un]=this.appCheckToken),Ai(t,Ni,l))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new ja(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(sl)),Pa(()=>{if(this.isClosed_)return;this.scriptTagHolder=new Dn((...r)=>{const[o,a,l,c,u]=r;if(this.incrementIncomingBytes_(r),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===ws)this.id=a,this.password=l;else if(o===za)a?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(a,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...r)=>{const[o,a]=r;this.incrementIncomingBytes_(r),this.myPacketOrderer.handleResponse(o,a)},()=>{this.onClosed_()},this.urlFn);const s={};s[ws]="t",s[Pi]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(s[Qa]=this.scriptTagHolder.uniqueCallbackIdentifier),s[vi]=An,this.transportSessionId&&(s[Ci]=this.transportSessionId),this.lastSessionId&&(s[bi]=this.lastSessionId),this.applicationId&&(s[Si]=this.applicationId),this.appCheckToken&&(s[un]=this.appCheckToken),typeof location<"u"&&location.hostname&&Ii.test(location.hostname)&&(s[Ei]=wi);const i=this.urlFn(s);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){ye.forceAllow_=!0}static forceDisallow(){ye.forceDisallow_=!0}static isAvailable(){return ye.forceAllow_?!0:!ye.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!Oa()&&!Ma()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=A(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const s=ti(t),i=mi(s,tl);for(let r=0;r<i.length;r++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[r]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const s={};s[el]="t",s[ki]=e,s[Di]=t,this.myDisconnFrame.src=this.urlFn(s),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=A(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class Dn{constructor(e,t,s,i){this.onDisconnect=s,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=Aa(),window[Ya+this.uniqueCallbackIdentifier]=e,window[Ka+this.uniqueCallbackIdentifier]=t,this.myIFrame=Dn.createIFrame_();let r="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(r='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+r+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(a){P("frame writing exception"),a.stack&&P(a.stack),P(a)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||P("No IE domain setting required")}catch{const s=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+s+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[ki]=this.myID,e[Di]=this.myPW,e[Pi]=this.currentSerial;let t=this.urlFn(e),s="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+Oi+s.length<=xi;){const o=this.pendingSegs.shift();s=s+"&"+Xa+i+"="+o.seg+"&"+Ja+i+"="+o.ts+"&"+Za+i+"="+o.d,i++}return t=t+s,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,s){this.pendingSegs.push({seg:e,ts:t,d:s}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const s=()=>{this.outstandingRequests.delete(t),this.newRequest_()},i=setTimeout(s,Math.floor(nl)),r=()=>{clearTimeout(i),s()};this.addTag(e,r)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const s=this.myIFrame.doc.createElement("script");s.type="text/javascript",s.async=!0,s.src=e,s.onload=s.onreadystatechange=function(){const i=s.readyState;(!i||i==="loaded"||i==="complete")&&(s.onload=s.onreadystatechange=null,s.parentNode&&s.parentNode.removeChild(s),t())},s.onerror=()=>{P("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(s)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yt extends Li{static getInstance(){return new yt}constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!ri()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return f(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class On extends Li{static getInstance(){return new On}constructor(){super(["visible"]);let e,t;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(t="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(t="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(t="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,()=>{const s=!document[e];s!==this.visible_&&(this.visible_=s,this.trigger("visible",s))},!1)}getInitialEvent(e){return f(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ct;class Wi extends Pt{static get __EMPTY_NODE(){return ct}static set __EMPTY_NODE(e){ct=e}compare(e,t){return fe(e.name,t.name)}isDefinedOn(e){throw Te("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return y.MIN}maxPost(){return new y(ne,ct)}makePost(e,t){return f(typeof e=="string","KeyIndex indexValue must always be a string."),new y(e,ct)}toString(){return".key"}}const Z=new Wi;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bl(n,e){return fe(n.name,e.name)}function Mn(n,e){return fe(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let dn;function Sl(n){dn=n}const Ui=function(n){return typeof n=="number"?"number:"+yi(n):"string:"+n},Hi=function(n){if(n.isLeafNode()){const e=n.val();f(typeof e=="string"||typeof e=="number"||typeof e=="object"&&$(e,".sv"),"Priority must be a string or number.")}else f(n===dn||n.isEmpty(),"priority of unexpected type.");f(n===dn||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Vi,$i;function Tl(n){Vi=n}function Nl(n){$i=n}class Rl extends Pt{compare(e,t){const s=e.node.getPriority(),i=t.node.getPriority(),r=s.compareTo(i);return r===0?fe(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return y.MIN}maxPost(){return new y(ne,new k("[PRIORITY-POST]",$i))}makePost(e,t){const s=Vi(e);return new y(t,new k("[PRIORITY-POST]",s))}toString(){return".priority"}}const T=new Rl;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xl extends Pt{compare(e,t){const s=e.node.compareTo(t.node);return s===0?fe(e.name,t.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return y.MIN}maxPost(){return y.MAX}makePost(e,t){const s=R(e);return new y(t,s)}toString(){return".value"}}const qi=new xl;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ln{constructor(e){this.index_=e}updateChild(e,t,s,i,r,o){f(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(i).equals(s.getChild(i))&&a.isEmpty()===s.isEmpty()||(o!=null&&(s.isEmpty()?e.hasChild(t)?o.trackChildChange(qe(t,a)):f(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(we(t,s)):o.trackChildChange(je(t,s,a))),e.isLeafNode()&&s.isEmpty())?e:e.updateImmediateChild(t,s).withIndex(this.index_)}updateFullNode(e,t,s){return s!=null&&(e.isLeafNode()||e.forEachChild(T,(i,r)=>{t.hasChild(i)||s.trackChildChange(qe(i,r))}),t.isLeafNode()||t.forEachChild(T,(i,r)=>{if(e.hasChild(i)){const o=e.getImmediateChild(i);o.equals(r)||s.trackChildChange(je(i,r,o))}else s.trackChildChange(we(i,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?g.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Et(){return{value:null,children:new Map}}function zi(n,e,t){if(v(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const s=m(e);n.children.has(s)||n.children.set(s,Et());const i=n.children.get(s);e=S(e),zi(i,e,t)}}function fn(n,e,t){n.value!==null?t(e,n.value):Ul(n,(s,i)=>{const r=new E(e.toString()+"/"+s);fn(i,r,t)})}function Ul(n,e){n.children.forEach((t,s)=>{e(s,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var H;(function(n){n[n.OVERWRITE=0]="OVERWRITE",n[n.MERGE=1]="MERGE",n[n.ACK_USER_WRITE=2]="ACK_USER_WRITE",n[n.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(H||(H={}));function Bn(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function Wn(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function Un(n){return{fromUser:!1,fromServer:!0,queryId:n,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wt{constructor(e,t,s){this.path=e,this.affectedTree=t,this.revert=s,this.type=H.ACK_USER_WRITE,this.source=Bn()}operationForChild(e){if(v(this.path)){if(this.affectedTree.value!=null)return f(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new E(e));return new wt(C(),t,this.revert)}}else return f(m(this.path)===e,"operationForChild called for unrelated child."),new wt(S(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xt(n,e){return{eventCache:n,serverCache:e}}function Fe(n,e,t,s){return xt(new ie(e,t,s),n.serverCache)}function Yi(n,e,t,s){return xt(n.eventCache,new ie(e,t,s))}function It(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function de(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ot(n,e){return Zi(e,n)}function Ql(n,e,t,s,i){f(s>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:s,visible:i}),i&&(n.visibleWrites=Be(n.visibleWrites,e,t)),n.lastWriteId=s}function Xl(n,e,t,s){f(s>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:s,visible:!0}),n.visibleWrites=_n(n.visibleWrites,e,t),n.lastWriteId=s}function Jl(n,e){for(let t=0;t<n.allWrites.length;t++){const s=n.allWrites[t];if(s.writeId===e)return s}return null}function Zl(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);f(t>=0,"removeWrite called with nonexistent writeId.");const s=n.allWrites[t];n.allWrites.splice(t,1);let i=s.visible,r=!1,o=n.allWrites.length-1;for(;i&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&ec(a,s.path)?i=!1:B(s.path,a.path)&&(r=!0)),o--}if(i){if(r)return tc(n),!0;if(s.snap)n.visibleWrites=Fs(n.visibleWrites,s.path);else{const a=s.children;x(a,l=>{n.visibleWrites=Fs(n.visibleWrites,N(s.path,l))})}return!0}else return!1}function ec(n,e){if(n.snap)return B(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&B(N(n.path,t),e))return!0;return!1}function tc(n){n.visibleWrites=Qi(n.allWrites,nc,C()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function nc(n){return n.visible}function Qi(n,e,t){let s=V.empty();for(let i=0;i<n.length;++i){const r=n[i];if(e(r)){const o=r.path;let a;if(r.snap)B(t,o)?(a=M(t,o),s=Be(s,a,r.snap)):B(o,t)&&(a=M(o,t),s=Be(s,C(),r.snap.getChild(a)));else if(r.children){if(B(t,o))a=M(t,o),s=_n(s,a,r.children);else if(B(o,t))if(a=M(o,t),v(a))s=_n(s,C(),r.children);else{const l=Ee(r.children,m(a));if(l){const c=l.getChild(S(a));s=Be(s,C(),c)}}}else throw Te("WriteRecord should have .snap or .children")}}return s}function Xi(n,e,t,s,i){if(!s&&!i){const r=_e(n.visibleWrites,e);if(r!=null)return r;{const o=ee(n.visibleWrites,e);if(gn(o))return t;if(t==null&&!pn(o,C()))return null;{const a=t||g.EMPTY_NODE;return be(o,a)}}}else{const r=ee(n.visibleWrites,e);if(!i&&gn(r))return t;if(!i&&t==null&&!pn(r,C()))return null;{const o=function(c){return(c.visible||i)&&(!s||!~s.indexOf(c.writeId))&&(B(c.path,e)||B(e,c.path))},a=Qi(n.allWrites,o,e),l=t||g.EMPTY_NODE;return be(a,l)}}}function sc(n,e,t){let s=g.EMPTY_NODE;const i=_e(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(T,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(t){const r=ee(n.visibleWrites,e);return t.forEachChild(T,(o,a)=>{const l=be(ee(r,new E(o)),a);s=s.updateImmediateChild(o,l)}),Bs(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=ee(n.visibleWrites,e);return Bs(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function ic(n,e,t,s,i){f(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=N(e,t);if(pn(n.visibleWrites,r))return null;{const o=ee(n.visibleWrites,r);return gn(o)?i.getChild(t):be(o,i.getChild(t))}}function rc(n,e,t,s){const i=N(e,t),r=_e(n.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(t)){const o=ee(n.visibleWrites,i);return be(o,s.getNode().getImmediateChild(t))}else return null}function oc(n,e){return _e(n.visibleWrites,e)}function ac(n,e,t,s,i,r,o){let a;const l=ee(n.visibleWrites,e),c=_e(l,C());if(c!=null)a=c;else if(t!=null)a=be(l,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],h=o.getCompare(),d=r?a.getReverseIteratorFrom(s,o):a.getIteratorFrom(s,o);let _=d.getNext();for(;_&&u.length<i;)h(_,s)!==0&&u.push(_),_=d.getNext();return u}else return[]}function lc(){return{visibleWrites:V.empty(),allWrites:[],lastWriteId:-1}}function bt(n,e,t,s){return Xi(n.writeTree,n.treePath,e,t,s)}function Hn(n,e){return sc(n.writeTree,n.treePath,e)}function Ws(n,e,t,s){return ic(n.writeTree,n.treePath,e,t,s)}function St(n,e){return oc(n.writeTree,N(n.treePath,e))}function cc(n,e,t,s,i,r){return ac(n.writeTree,n.treePath,e,t,s,i,r)}function Vn(n,e,t){return rc(n.writeTree,n.treePath,e,t)}function Ji(n,e){return Zi(N(n.treePath,e),n.writeTree)}function Zi(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uc{getCompleteChild(e){return null}getChildAfterChild(e,t,s){return null}}const er=new uc;class $n{constructor(e,t,s=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=s}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new ie(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Vn(this.writes_,e,s)}}getChildAfterChild(e,t,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:de(this.viewCache_),r=cc(this.writes_,i,t,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cc{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const s=this.query_._queryParams,i=new Ln(s.getIndex()),r=Ll(s);this.processor_=dc(r);const o=t.serverCache,a=t.eventCache,l=i.updateFullNode(g.EMPTY_NODE,o.getNode(),null),c=r.updateFullNode(g.EMPTY_NODE,a.getNode(),null),u=new ie(l,o.isFullyInitialized(),i.filtersNodes()),h=new ie(c,a.isFullyInitialized(),r.filtersNodes());this.viewCache_=xt(h,u),this.eventGenerator_=new ql(this.query_)}get query(){return this.query_}}function Ec(n){return n.viewCache_.serverCache.getNode()}function wc(n){return It(n.viewCache_)}function Ic(n,e){const t=de(n.viewCache_);return t&&(n.query._queryParams.loadsAllData()||!v(e)&&!t.getImmediateChild(m(e)).isEmpty())?t.getChild(e):null}function Vs(n){return n.eventRegistrations_.length===0}function bc(n,e){n.eventRegistrations_.push(e)}function $s(n,e,t){const s=[];if(t){f(e==null,"A cancel should cancel all event registrations.");const i=n.query._path;n.eventRegistrations_.forEach(r=>{const o=r.createCancelEvent(t,i);o&&s.push(o)})}if(e){let i=[];for(let r=0;r<n.eventRegistrations_.length;++r){const o=n.eventRegistrations_[r];if(!o.matches(e))i.push(o);else if(e.hasAnyCallback()){i=i.concat(n.eventRegistrations_.slice(r+1));break}}n.eventRegistrations_=i}else n.eventRegistrations_=[];return s}function Gs(n,e,t,s){e.type===H.MERGE&&e.source.queryId!==null&&(f(de(n.viewCache_),"We should always have a full cache before handling merges"),f(It(n.viewCache_),"Missing event cache, even though we have a server cache"));const i=n.viewCache_,r=_c(n.processor_,i,e,t,s);return fc(n.processor_,r.viewCache),f(r.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),n.viewCache_=r.viewCache,nr(n,r.changes,r.viewCache.eventCache.getNode(),null)}function Sc(n,e){const t=n.viewCache_.eventCache,s=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(T,(r,o)=>{s.push(we(r,o))}),t.isFullyInitialized()&&s.push(ji(t.getNode())),nr(n,s,t.getNode(),e)}function nr(n,e,t,s){const i=s?[s]:n.eventRegistrations_;return jl(n.eventGenerator_,e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Nt;class sr{constructor(){this.views=new Map}}function Tc(n){f(!Nt,"__referenceConstructor has already been defined"),Nt=n}function Nc(){return f(Nt,"Reference.ts has not been loaded"),Nt}function Rc(n){return n.views.size===0}function Gn(n,e,t,s){const i=e.source.queryId;if(i!==null){const r=n.views.get(i);return f(r!=null,"SyncTree gave us an op for an invalid query."),Gs(r,e,t,s)}else{let r=[];for(const o of n.views.values())r=r.concat(Gs(o,e,t,s));return r}}function ir(n,e,t,s,i){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let a=bt(t,i?s:null),l=!1;a?l=!0:s instanceof g?(a=Hn(t,s),l=!1):(a=g.EMPTY_NODE,l=!1);const c=xt(new ie(a,l,!1),new ie(s,i,!1));return new Cc(e,c)}return o}function Ac(n,e,t,s,i,r){const o=ir(n,e,s,i,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),bc(o,t),Sc(o,t)}function kc(n,e,t,s){const i=e._queryIdentifier,r=[];let o=[];const a=re(n);if(i==="default")for(const[l,c]of n.views.entries())o=o.concat($s(c,t,s)),Vs(c)&&(n.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=n.views.get(i);l&&(o=o.concat($s(l,t,s)),Vs(l)&&(n.views.delete(i),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!re(n)&&r.push(new(Nc())(e._repo,e._path)),{removed:r,events:o}}function rr(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function te(n,e){let t=null;for(const s of n.views.values())t=t||Ic(s,e);return t}function or(n,e){if(e._queryParams.loadsAllData())return Mt(n);{const s=e._queryIdentifier;return n.views.get(s)}}function ar(n,e){return or(n,e)!=null}function re(n){return Mt(n)!=null}function Mt(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Rt;function Dc(n){f(!Rt,"__referenceConstructor has already been defined"),Rt=n}function Pc(){return f(Rt,"Reference.ts has not been loaded"),Rt}let xc=1;class qs{constructor(e){this.listenProvider_=e,this.syncPointTree_=new I(null),this.pendingWriteTree_=lc(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function lr(n,e,t,s,i){return Ql(n.pendingWriteTree_,e,t,s,i),i?Re(n,new ue(Bn(),e,t)):[]}function Oc(n,e,t,s){Xl(n.pendingWriteTree_,e,t,s);const i=I.fromObject(t);return Re(n,new Ie(Bn(),e,i))}function Q(n,e,t=!1){const s=Jl(n.pendingWriteTree_,e);if(Zl(n.pendingWriteTree_,e)){let r=new I(null);return s.snap!=null?r=r.set(C(),!0):x(s.children,o=>{r=r.set(new E(o),!0)}),Re(n,new wt(s.path,r,t))}else return[]}function st(n,e,t){return Re(n,new ue(Wn(),e,t))}function Mc(n,e,t){const s=I.fromObject(t);return Re(n,new Ie(Wn(),e,s))}function Lc(n,e){return Re(n,new Ye(Wn(),e))}function Fc(n,e,t){const s=jn(n,t);if(s){const i=zn(s),r=i.path,o=i.queryId,a=M(r,e),l=new Ye(Un(o),a);return Yn(n,r,l)}else return[]}function At(n,e,t,s,i=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||ar(o,e))){const l=kc(o,e,t,s);Rc(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!i){const u=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(r,(d,_)=>re(_));if(u&&!h){const d=n.syncPointTree_.subtree(r);if(!d.isEmpty()){const _=Uc(d);for(let p=0;p<_.length;++p){const w=_[p],O=w.query,pe=dr(n,w);n.listenProvider_.startListening(We(O),Ke(n,O),pe.hashFn,pe.onComplete)}}}!h&&c.length>0&&!s&&(u?n.listenProvider_.stopListening(We(e),null):c.forEach(d=>{const _=n.queryToTagMap.get(Lt(d));n.listenProvider_.stopListening(We(d),_)}))}Hc(n,c)}return a}function cr(n,e,t,s){const i=jn(n,s);if(i!=null){const r=zn(i),o=r.path,a=r.queryId,l=M(o,e),c=new ue(Un(a),l,t);return Yn(n,o,c)}else return[]}function Bc(n,e,t,s){const i=jn(n,s);if(i){const r=zn(i),o=r.path,a=r.queryId,l=M(o,e),c=I.fromObject(t),u=new Ie(Un(a),l,c);return Yn(n,o,u)}else return[]}function vn(n,e,t,s=!1){const i=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(i,(d,_)=>{const p=M(d,i);r=r||te(_,p),o=o||re(_)});let a=n.syncPointTree_.get(i);a?(o=o||re(a),r=r||te(a,C())):(a=new sr,n.syncPointTree_=n.syncPointTree_.set(i,a));let l;r!=null?l=!0:(l=!1,r=g.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((_,p)=>{const w=te(p,C());w&&(r=r.updateImmediateChild(_,w))}));const c=ar(a,e);if(!c&&!e._queryParams.loadsAllData()){const d=Lt(e);f(!n.queryToTagMap.has(d),"View does not exist, but we have a tag");const _=Vc();n.queryToTagMap.set(d,_),n.tagToQueryMap.set(_,d)}const u=Ot(n.pendingWriteTree_,i);let h=Ac(a,e,t,u,r,l);if(!c&&!o&&!s){const d=or(a,e);h=h.concat($c(n,e,d))}return h}function qn(n,e,t){const i=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=M(o,e),c=te(a,l);if(c)return c});return Xi(i,e,r,t,!0)}function Wc(n,e){const t=e._path;let s=null;n.syncPointTree_.foreachOnPath(t,(c,u)=>{const h=M(c,t);s=s||te(u,h)});let i=n.syncPointTree_.get(t);i?s=s||te(i,C()):(i=new sr,n.syncPointTree_=n.syncPointTree_.set(t,i));const r=s!=null,o=r?new ie(s,!0,!1):null,a=Ot(n.pendingWriteTree_,e._path),l=ir(i,e,a,r?o.getNode():g.EMPTY_NODE,r);return wc(l)}function Re(n,e){return hr(e,n.syncPointTree_,null,Ot(n.pendingWriteTree_,C()))}function hr(n,e,t,s){if(v(n.path))return ur(n,e,t,s);{const i=e.get(C());t==null&&i!=null&&(t=te(i,C()));let r=[];const o=m(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,u=Ji(s,o);r=r.concat(hr(a,l,c,u))}return i&&(r=r.concat(Gn(i,n,s,t))),r}}function ur(n,e,t,s){const i=e.get(C());t==null&&i!=null&&(t=te(i,C()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=Ji(s,o),u=n.operationForChild(o);u&&(r=r.concat(ur(u,a,l,c)))}),i&&(r=r.concat(Gn(i,n,s,t))),r}function dr(n,e){const t=e.query,s=Ke(n,t);return{hashFn:()=>(Ec(e)||g.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?Fc(n,t._path,s):Lc(n,t._path);{const r=La(i,t);return At(n,t,null,r)}}}}function Ke(n,e){const t=Lt(e);return n.queryToTagMap.get(t)}function Lt(n){return n._path.toString()+"$"+n._queryIdentifier}function jn(n,e){return n.tagToQueryMap.get(e)}function zn(n){const e=n.indexOf("$");return f(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new E(n.substr(0,e))}}function Yn(n,e,t){const s=n.syncPointTree_.get(e);f(s,"Missing sync point for query tag that we're tracking");const i=Ot(n.pendingWriteTree_,e);return Gn(s,t,i,null)}function Uc(n){return n.fold((e,t,s)=>{if(t&&re(t))return[Mt(t)];{let i=[];return t&&(i=rr(t)),x(s,(r,o)=>{i=i.concat(o)}),i}})}function We(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(Pc())(n._repo,n._path):n}function Hc(n,e){for(let t=0;t<e.length;++t){const s=e[t];if(!s._queryParams.loadsAllData()){const i=Lt(s),r=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(r)}}}function Vc(){return xc++}function $c(n,e,t){const s=e._path,i=Ke(n,e),r=dr(n,t),o=n.listenProvider_.startListening(We(e),i,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(s);if(i)f(!re(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,u,h)=>{if(!v(c)&&u&&re(u))return[Mt(u).query];{let d=[];return u&&(d=d.concat(rr(u).map(_=>_.query))),x(h,(_,p)=>{d=d.concat(p)}),d}});for(let c=0;c<l.length;++c){const u=l[c];n.listenProvider_.stopListening(We(u),Ke(n,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kn{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new Kn(t)}node(){return this.node_}}class Qn{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=N(this.path_,e);return new Qn(this.syncTree_,t)}node(){return qn(this.syncTree_,this.path_)}}const Gc=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},js=function(n,e,t){if(!n||typeof n!="object")return n;if(f(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return qc(n[".sv"],e,t);if(typeof n[".sv"]=="object")return jc(n[".sv"],e);f(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},qc=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:f(!1,"Unexpected server value: "+n)}},jc=function(n,e,t){n.hasOwnProperty("increment")||f(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const s=n.increment;typeof s!="number"&&f(!1,"Unexpected increment value: "+s);const i=e.node();if(f(i!==null&&typeof i<"u","Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return s;const o=i.getValue();return typeof o!="number"?s:o+s},fr=function(n,e,t,s){return Xn(e,new Qn(t,n),s)},_r=function(n,e,t){return Xn(n,new Kn(e),t)};function Xn(n,e,t){const s=n.getPriority().val(),i=js(s,e.getImmediateChild(".priority"),t);let r;if(n.isLeafNode()){const o=n,a=js(o.getValue(),e,t);return a!==o.getValue()||i!==o.getPriority().val()?new k(a,R(i)):n}else{const o=n;return r=o,i!==o.getPriority().val()&&(r=r.updatePriority(new k(i))),o.forEachChild(T,(a,l)=>{const c=Xn(l,e.getImmediateChild(a),t);c!==l&&(r=r.updateImmediateChild(a,c))}),r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jn{constructor(e="",t=null,s={children:{},childCount:0}){this.name=e,this.parent=t,this.node=s}}function Zn(n,e){let t=e instanceof E?e:new E(e),s=n,i=m(t);for(;i!==null;){const r=Ee(s.node.children,i)||{children:{},childCount:0};s=new Jn(i,s,r),t=S(t),i=m(t)}return s}function Ae(n){return n.node.value}function pr(n,e){n.node.value=e,Cn(n)}function gr(n){return n.node.childCount>0}function zc(n){return Ae(n)===void 0&&!gr(n)}function Ft(n,e){x(n.node.children,(t,s)=>{e(new Jn(t,n,s))})}function mr(n,e,t,s){t&&e(n),Ft(n,i=>{mr(i,e,!0)})}function Yc(n,e,t){let s=n.parent;for(;s!==null;){if(e(s))return!0;s=s.parent}return!1}function it(n){return new E(n.parent===null?n.name:it(n.parent)+"/"+n.name)}function Cn(n){n.parent!==null&&Kc(n.parent,n.name,n)}function Kc(n,e,t){const s=zc(t),i=$(n.node.children,e);s&&i?(delete n.node.children[e],n.node.childCount--,Cn(n)):!s&&!i&&(n.node.children[e]=t.node,n.node.childCount++,Cn(n))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qc=/[\[\].#$\/\u0000-\u001F\u007F]/,Xc=/[\[\].#$\u0000-\u001F\u007F]/,tn=10*1024*1024,es=function(n){return typeof n=="string"&&n.length!==0&&!Qc.test(n)},yr=function(n){return typeof n=="string"&&n.length!==0&&!Xc.test(n)},Jc=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),yr(n)},En=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!Nn(n)||n&&typeof n=="object"&&$(n,".sv")},vr=function(n,e,t,s){s&&e===void 0||Bt(kt(n,"value"),e,t)},Bt=function(n,e,t){const s=t instanceof E?new gl(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+le(s));if(typeof e=="function")throw new Error(n+"contains a function "+le(s)+" with contents = "+e.toString());if(Nn(e))throw new Error(n+"contains "+e.toString()+" "+le(s));if(typeof e=="string"&&e.length>tn/3&&Dt(e)>tn)throw new Error(n+"contains a string greater than "+tn+" utf8 bytes "+le(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(x(e,(o,a)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!es(o)))throw new Error(n+" contains an invalid key ("+o+") "+le(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);ml(s,o),Bt(n,a,s),yl(s)}),i&&r)throw new Error(n+' contains ".value" child '+le(s)+" in addition to actual children.")}},Zc=function(n,e){let t,s;for(t=0;t<e.length;t++){s=e[t];const r=Ge(s);for(let o=0;o<r.length;o++)if(!(r[o]===".priority"&&o===r.length-1)){if(!es(r[o]))throw new Error(n+"contains an invalid key ("+r[o]+") in path "+s.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(pl);let i=null;for(t=0;t<e.length;t++){if(s=e[t],i!==null&&B(i,s))throw new Error(n+"contains a path "+i.toString()+" that is ancestor of another path "+s.toString());i=s}},eh=function(n,e,t,s){const i=kt(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const r=[];x(e,(o,a)=>{const l=new E(o);if(Bt(i,a,N(t,l)),Pn(l)===".priority"&&!En(a))throw new Error(i+"contains an invalid value for '"+l.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(l)}),Zc(i,r)},Cr=function(n,e,t,s){if(!yr(t))throw new Error(kt(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},th=function(n,e,t,s){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Cr(n,e,t)},Er=function(n,e){if(m(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},nh=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!es(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!Jc(t))throw new Error(kt(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sh{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Wt(n,e){let t=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();t!==null&&!xn(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(i)}t&&n.eventLists_.push(t)}function wr(n,e,t){Wt(n,t),Ir(n,s=>xn(s,e))}function W(n,e,t){Wt(n,t),Ir(n,s=>B(s,e)||B(e,s))}function Ir(n,e){n.recursionDepth_++;let t=!0;for(let s=0;s<n.eventLists_.length;s++){const i=n.eventLists_[s];if(i){const r=i.path;e(r)?(ih(n.eventLists_[s]),n.eventLists_[s]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function ih(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const s=t.getEventRunner();Me&&P("event: "+t.toString()),Ne(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rh="repo_interrupt",oh=25;class ah{constructor(e,t,s,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new sh,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Et(),this.transactionQueueTree_=new Jn,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function lh(n,e,t){if(n.stats_=kn(n.repoInfo_),n.forceRestClient_||Ua())n.server_=new Ct(n.repoInfo_,(s,i,r,o)=>{zs(n,s,i,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>Ys(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{A(t)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}n.persistentConnection_=new q(n.repoInfo_,e,(s,i,r,o)=>{zs(n,s,i,r,o)},s=>{Ys(n,s)},s=>{ch(n,s)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(s=>{n.server_.refreshAuthToken(s)}),n.appCheckProvider_.addTokenChangeListener(s=>{n.server_.refreshAppCheckToken(s.token)}),n.statsReporter_=qa(n.repoInfo_,()=>new Gl(n.stats_,n.server_)),n.infoData_=new Wl,n.infoSyncTree_=new qs({startListening:(s,i,r,o)=>{let a=[];const l=n.infoData_.getNode(s._path);return l.isEmpty()||(a=st(n.infoSyncTree_,s._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),ts(n,"connected",!1),n.serverSyncTree_=new qs({startListening:(s,i,r,o)=>(n.server_.listen(s,r,i,(a,l)=>{const c=o(a,l);W(n.eventQueue_,s._path,c)}),[]),stopListening:(s,i)=>{n.server_.unlisten(s,i)}})}function br(n){const t=n.infoData_.getNode(new E(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Ut(n){return Gc({timestamp:br(n)})}function zs(n,e,t,s,i){n.dataUpdateCount++;const r=new E(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(i)if(s){const l=ft(t,c=>R(c));o=Bc(n.serverSyncTree_,r,l,i)}else{const l=R(t);o=cr(n.serverSyncTree_,r,l,i)}else if(s){const l=ft(t,c=>R(c));o=Mc(n.serverSyncTree_,r,l)}else{const l=R(t);o=st(n.serverSyncTree_,r,l)}let a=r;o.length>0&&(a=Se(n,r)),W(n.eventQueue_,a,o)}function Ys(n,e){ts(n,"connected",e),e===!1&&fh(n)}function ch(n,e){x(e,(t,s)=>{ts(n,t,s)})}function ts(n,e,t){const s=new E("/.info/"+e),i=R(t);n.infoData_.updateSnapshot(s,i);const r=st(n.infoSyncTree_,s,i);W(n.eventQueue_,s,r)}function ns(n){return n.nextWriteId_++}function hh(n,e,t){const s=Wc(n.serverSyncTree_,e);return s!=null?Promise.resolve(s):n.server_.get(e).then(i=>{const r=R(i).withIndex(e._queryParams.getIndex());vn(n.serverSyncTree_,e,t,!0);let o;if(e._queryParams.loadsAllData())o=st(n.serverSyncTree_,e._path,r);else{const a=Ke(n.serverSyncTree_,e);o=cr(n.serverSyncTree_,e._path,r,a)}return W(n.eventQueue_,e._path,o),At(n.serverSyncTree_,e,t,null,!0),r},i=>(rt(n,"get for query "+A(e)+" failed: "+i),Promise.reject(new Error(i))))}function uh(n,e,t,s,i){rt(n,"set",{path:e.toString(),value:t,priority:s});const r=Ut(n),o=R(t,s),a=qn(n.serverSyncTree_,e),l=_r(o,a,r),c=ns(n),u=lr(n.serverSyncTree_,e,l,c,!0);Wt(n.eventQueue_,u),n.server_.put(e.toString(),o.val(!0),(d,_)=>{const p=d==="ok";p||L("set at "+e+" failed: "+d);const w=Q(n.serverSyncTree_,c,!p);W(n.eventQueue_,e,w),wn(n,i,d,_)});const h=is(n,e);Se(n,h),W(n.eventQueue_,h,[])}function dh(n,e,t,s){rt(n,"update",{path:e.toString(),value:t});let i=!0;const r=Ut(n),o={};if(x(t,(a,l)=>{i=!1,o[a]=fr(N(e,a),R(l),n.serverSyncTree_,r)}),i)P("update() called with empty data.  Don't do anything."),wn(n,s,"ok",void 0);else{const a=ns(n),l=Oc(n.serverSyncTree_,e,o,a);Wt(n.eventQueue_,l),n.server_.merge(e.toString(),t,(c,u)=>{const h=c==="ok";h||L("update at "+e+" failed: "+c);const d=Q(n.serverSyncTree_,a,!h),_=d.length>0?Se(n,e):e;W(n.eventQueue_,_,d),wn(n,s,c,u)}),x(t,c=>{const u=is(n,N(e,c));Se(n,u)}),W(n.eventQueue_,e,[])}}function fh(n){rt(n,"onDisconnectEvents");const e=Ut(n),t=Et();fn(n.onDisconnect_,C(),(i,r)=>{const o=fr(i,r,n.serverSyncTree_,e);zi(t,i,o)});let s=[];fn(t,C(),(i,r)=>{s=s.concat(st(n.serverSyncTree_,i,r));const o=is(n,i);Se(n,o)}),n.onDisconnect_=Et(),W(n.eventQueue_,C(),s)}function _h(n,e,t){let s;m(e._path)===".info"?s=vn(n.infoSyncTree_,e,t):s=vn(n.serverSyncTree_,e,t),wr(n.eventQueue_,e._path,s)}function ph(n,e,t){let s;m(e._path)===".info"?s=At(n.infoSyncTree_,e,t):s=At(n.serverSyncTree_,e,t),wr(n.eventQueue_,e._path,s)}function gh(n){n.persistentConnection_&&n.persistentConnection_.interrupt(rh)}function rt(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),P(t,...e)}function wn(n,e,t,s){e&&Ne(()=>{if(t==="ok")e(null);else{const i=(t||"error").toUpperCase();let r=i;s&&(r+=": "+s);const o=new Error(r);o.code=i,e(o)}})}function Sr(n,e,t){return qn(n.serverSyncTree_,e,t)||g.EMPTY_NODE}function ss(n,e=n.transactionQueueTree_){if(e||Ht(n,e),Ae(e)){const t=Nr(n,e);f(t.length>0,"Sending zero length transaction queue"),t.every(i=>i.status===0)&&mh(n,it(e),t)}else gr(e)&&Ft(e,t=>{ss(n,t)})}function mh(n,e,t){const s=t.map(c=>c.currentWriteId),i=Sr(n,e,s);let r=i;const o=i.hash();for(let c=0;c<t.length;c++){const u=t[c];f(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const h=M(e,u.path);r=r.updateChild(h,u.currentOutputSnapshotRaw)}const a=r.val(!0),l=e;n.server_.put(l.toString(),a,c=>{rt(n,"transaction put response",{path:l.toString(),status:c});let u=[];if(c==="ok"){const h=[];for(let d=0;d<t.length;d++)t[d].status=2,u=u.concat(Q(n.serverSyncTree_,t[d].currentWriteId)),t[d].onComplete&&h.push(()=>t[d].onComplete(null,!0,t[d].currentOutputSnapshotResolved)),t[d].unwatcher();Ht(n,Zn(n.transactionQueueTree_,e)),ss(n,n.transactionQueueTree_),W(n.eventQueue_,e,u);for(let d=0;d<h.length;d++)Ne(h[d])}else{if(c==="datastale")for(let h=0;h<t.length;h++)t[h].status===3?t[h].status=4:t[h].status=0;else{L("transaction at "+l.toString()+" failed: "+c);for(let h=0;h<t.length;h++)t[h].status=4,t[h].abortReason=c}Se(n,e)}},o)}function Se(n,e){const t=Tr(n,e),s=it(t),i=Nr(n,t);return yh(n,i,s),s}function yh(n,e,t){if(e.length===0)return;const s=[];let i=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=M(t,l.path);let u=!1,h;if(f(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)u=!0,h=l.abortReason,i=i.concat(Q(n.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=oh)u=!0,h="maxretry",i=i.concat(Q(n.serverSyncTree_,l.currentWriteId,!0));else{const d=Sr(n,l.path,o);l.currentInputSnapshot=d;const _=e[a].update(d.val());if(_!==void 0){Bt("transaction failed: Data returned ",_,l.path);let p=R(_);typeof _=="object"&&_!=null&&$(_,".priority")||(p=p.updatePriority(d.getPriority()));const O=l.currentWriteId,pe=Ut(n),at=_r(p,d,pe);l.currentOutputSnapshotRaw=p,l.currentOutputSnapshotResolved=at,l.currentWriteId=ns(n),o.splice(o.indexOf(O),1),i=i.concat(lr(n.serverSyncTree_,l.path,at,l.currentWriteId,l.applyLocally)),i=i.concat(Q(n.serverSyncTree_,O,!0))}else u=!0,h="nodata",i=i.concat(Q(n.serverSyncTree_,l.currentWriteId,!0))}W(n.eventQueue_,t,i),i=[],u&&(e[a].status=2,function(d){setTimeout(d,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(h==="nodata"?s.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):s.push(()=>e[a].onComplete(new Error(h),!1,null))))}Ht(n,n.transactionQueueTree_);for(let a=0;a<s.length;a++)Ne(s[a]);ss(n,n.transactionQueueTree_)}function Tr(n,e){let t,s=n.transactionQueueTree_;for(t=m(e);t!==null&&Ae(s)===void 0;)s=Zn(s,t),e=S(e),t=m(e);return s}function Nr(n,e){const t=[];return Rr(n,e,t),t.sort((s,i)=>s.order-i.order),t}function Rr(n,e,t){const s=Ae(e);if(s)for(let i=0;i<s.length;i++)t.push(s[i]);Ft(e,i=>{Rr(n,i,t)})}function Ht(n,e){const t=Ae(e);if(t){let s=0;for(let i=0;i<t.length;i++)t[i].status!==2&&(t[s]=t[i],s++);t.length=s,pr(e,t.length>0?t:void 0)}Ft(e,s=>{Ht(n,s)})}function is(n,e){const t=it(Tr(n,e)),s=Zn(n.transactionQueueTree_,e);return Yc(s,i=>{nn(n,i)}),nn(n,s),mr(s,i=>{nn(n,i)}),t}function nn(n,e){const t=Ae(e);if(t){const s=[];let i=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(f(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(f(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),i=i.concat(Q(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&s.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?pr(e,void 0):t.length=r+1,W(n.eventQueue_,it(e),i);for(let o=0;o<s.length;o++)Ne(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qs="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",wh=function(){let n=0;const e=[];return function(t){const s=t===n;n=t;let i;const r=new Array(8);for(i=7;i>=0;i--)r[i]=Qs.charAt(t%64),t=Math.floor(t/64);f(t===0,"Cannot push at time == 0");let o=r.join("");if(s){for(i=11;i>=0&&e[i]===63;i--)e[i]=0;e[i]++}else for(i=0;i<12;i++)e[i]=Math.floor(Math.random()*64);for(i=0;i<12;i++)o+=Qs.charAt(e[i]);return f(o.length===20,"nextPushId: Length should be 20."),o}}();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ot{constructor(e,t,s,i){this._repo=e,this._path=t,this._queryParams=s,this._orderByCalled=i}get key(){return v(this._path)?null:Pn(this._path)}get ref(){return new Y(this._repo,this._path)}get _queryIdentifier(){const e=Ms(this._queryParams),t=Rn(e);return t==="{}"?"default":t}get _queryObject(){return Ms(this._queryParams)}isEqual(e){if(e=oe(e),!(e instanceof ot))return!1;const t=this._repo===e._repo,s=xn(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+_l(this._path)}}function Sh(n,e){if(n._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function Th(n){let e=null,t=null;if(n.hasStart()&&(e=n.getIndexStartValue()),n.hasEnd()&&(t=n.getIndexEndValue()),n.getIndex()===Z){const s="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(n.hasStart()){if(n.getIndexStartName()!==he)throw new Error(s);if(typeof e!="string")throw new Error(i)}if(n.hasEnd()){if(n.getIndexEndName()!==ne)throw new Error(s);if(typeof t!="string")throw new Error(i)}}else if(n.getIndex()===T){if(e!=null&&!En(e)||t!=null&&!En(t))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(f(n.getIndex()instanceof Gi||n.getIndex()===qi,"unknown index type."),e!=null&&typeof e=="object"||t!=null&&typeof t=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}class Y extends ot{constructor(e,t){super(e,t,new Fn,!1)}get parent(){const e=Fi(this._path);return e===null?null:new Y(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Qe{constructor(e,t,s){this._node=e,this.ref=t,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new E(e),s=Xe(this.ref,e);return new Qe(this._node.getChild(t),s,T)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new Qe(i,Xe(this.ref,s),T)))}hasChild(e){const t=new E(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Oe(n,e){return n=oe(n),n._checkNotDeleted("ref"),e!==void 0?Xe(n._root,e):n._root}function Xe(n,e){return n=oe(n),m(n._path)===null?th("child","path",e):Cr("child","path",e),new Y(n._repo,N(n._path,e))}function Nh(n,e){n=oe(n),Er("push",n._path),vr("push",e,n._path,!0);const t=br(n._repo),s=wh(t),i=Xe(n,s),r=Xe(n,s);let o;return o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function Xs(n,e){n=oe(n),Er("set",n._path),vr("set",e,n._path,!1);const t=new Je;return uh(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function Rh(n,e){eh("update",e,n._path);const t=new Je;return dh(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function In(n){n=oe(n);const e=new Ar(()=>{}),t=new Vt(e);return hh(n._repo,n,t).then(s=>new Qe(s,new Y(n._repo,n._path),n._queryParams.getIndex()))}class Vt{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const s=t._queryParams.getIndex();return new Ih("value",this,new Qe(e.snapshotNode,new Y(t._repo,t._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new bh(this,e,t):null}matches(e){return e instanceof Vt?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Ah(n,e,t,s,i){const r=new Ar(t,void 0),o=new Vt(r);return _h(n._repo,n,o),()=>ph(n._repo,n,o)}function kh(n,e,t,s){return Ah(n,"value",e)}class kr{}class Dh extends kr{constructor(e){super(),this._limit=e,this.type="limitToLast"}_apply(e){if(e._queryParams.hasLimit())throw new Error("limitToLast: Limit was already set (by another call to limitToFirst or limitToLast).");return new ot(e._repo,e._path,Fl(e._queryParams,this._limit),e._orderByCalled)}}function Dr(n){if(Math.floor(n)!==n||n<=0)throw new Error("limitToLast: First argument must be a positive integer.");return new Dh(n)}class Ph extends kr{constructor(){super(...arguments),this.type="orderByKey"}_apply(e){Sh(e,"orderByKey");const t=Bl(e._queryParams,Z);return Th(t),new ot(e._repo,e._path,t,!0)}}function Pr(){return new Ph}function xr(n,...e){let t=oe(n);for(const s of e)t=s._apply(t);return t}Tc(Y);Dc(Y);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vh(n){Sa(ua),gt(new He("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Lh(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),ve(ys,vs,n),ve(ys,vs,"esm2017")}q.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};q.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};Vh();function $h(){const n=new Date,e=String(n.getDate()).padStart(2,"0"),t=String(n.getMonth()+1).padStart(2,"0"),s=n.getFullYear(),i=n.getHours(),r=n.getMinutes();return`${e}/${t}/${s} ${i}:${r}`}const Gh={apiKey:"AIzaSyDHM9fZ9XcWFWEWpjw8vjK2jVPGVaVS4LQ",authDomain:"limpiezapiso-cb761.firebaseapp.com",databaseURL:"https://limpiezapiso-cb761-default-rtdb.europe-west1.firebasedatabase.app",projectId:"limpiezapiso-cb761",storageBucket:"limpiezapiso-cb761.firebasestorage.app",messagingSenderId:"221021062267",appId:"1:221021062267:web:c4327bf470045224534ede",measurementId:"G-WH0M189T28"},Or=ui(Gh),me=Uh(Or);class qh{constructor(){this.app=Or,this.db=me,this.path="piso"}insert(e,t){Xs(Oe(me,this.path+e),t)}async initWeek(e){const t=Br(),s=new Date().getFullYear(),i=Oe(me,this.path),r=xr(i,Pr(),Dr(1)),o=await In(r);console.log("snapshot",o);let a=!0;if(o.exists()){const l=Object.values(o.val())[0];console.log(l),l.year==s&&l.week==t&&(a=!1)}if(a){const l=Nh(i);await Xs(l,{year:s,week:t,usuarios:e})}}async listenToUser(e,t){const s=await Js(),i=Oe(me,`piso/${s}/usuarios/${e}`);console.log(i),kh(i,r=>{const o=r.val().done;t(o)})}async toggleDone(e){const t=await Js();if(!t){console.log("❌ No hay registros en la base de datos.");return}const s=Oe(me,`piso/${t}/usuarios/${e}`),i=await In(s);if(!i.exists()){console.log(`❌ El usuario ${e} no existe en el último registro.`);return}const o=!i.val().done,a=$h();console.log(a),await Rh(s,{done:o,fecha:o?a:"not done"})}}const Js=async()=>{const n=Oe(me,"piso"),e=xr(n,Pr(),Dr(1)),t=await In(e);if(t.exists()){const s=t.val(),[i]=Object.keys(s);return i}return null},jh=[new lt("Álvaro"),new lt("Rubén"),new lt("Joan"),new lt("Álex")],Mr=new Fr(jh),K=new qh,zh=document.querySelector("#alvaroTask"),Yh=document.querySelector("#alexTask"),Kh=document.querySelector("#joanTask"),Qh=document.querySelector("#rubiuTask"),Xh=document.querySelector("#diaLabel"),Jh=document.querySelector("#semanaLabel"),Zh=document.querySelector("#alvaroCard"),eu=document.querySelector("#joanCard"),tu=document.querySelector("#alexCard"),nu=document.querySelector("#rubiusCard"),su=document.querySelector("#rubiusBorder"),iu=document.querySelector("#alvaroBorder"),ru=document.querySelector("#alexBorder"),ou=document.querySelector("#joanBorder"),$t=Mr.getTaskOrder(),au={usuario0:{nombre:"Rubiu",done:!1,fecha:"not done"},usuario1:{nombre:"Álvaro",done:!1,fecha:"not done"},usuario2:{nombre:"Joan",done:!1,fecha:"not done"},usuario3:{nombre:"Alex",done:!1,fecha:"not done"}};setInterval(K.initWeek(au),5*60*1e3);Zh.addEventListener("click",async()=>{await K.toggleDone("usuario1")});eu.addEventListener("click",async()=>{await K.toggleDone("usuario2")});tu.addEventListener("click",async()=>{await K.toggleDone("usuario3")});nu.addEventListener("click",async()=>{await K.toggleDone("usuario0")});K.listenToUser("usuario1",n=>{Gt(iu,n)});K.listenToUser("usuario0",n=>{Gt(su,n)});K.listenToUser("usuario2",n=>{Gt(ou,n)});K.listenToUser("usuario3",n=>{Gt(ru,n)});zh.textContent=$t[1];Yh.textContent=$t[3];Kh.textContent=$t[2];Qh.textContent=$t[0];const rs=new Date,lu=String(rs.getDate()).padStart(2,"0"),cu=String(rs.getMonth()+1).padStart(2,"0"),hu=rs.getFullYear();Xh.textContent=`DIA: ${lu}/${cu}/${hu}`;const uu=Mr.getWeekOfYear();Jh.textContent=`SEMANA: ${uu}`;function Gt(n,e){e?(n.classList.add("from-green-400"),n.classList.add("to-emerald-500"),n.classList.remove("from-red-500"),n.classList.remove("to-red-700")):(n.classList.remove("from-green-400"),n.classList.remove("to-emerald-500"),n.classList.add("from-red-500"),n.classList.add("to-red-700"))}
