 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vh(n){Sa(ua),gt(new He("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Lh(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),ve(ys,vs,n),ve(ys,vs,"esm2017")}q.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};q.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};Vh();const $h={apiKey:"AIzaSyDHM9fZ9XcWFWEWpjw8vjK2jVPGVaVS4LQ",authDomain:"limpiezapiso-cb761.firebaseapp.com",databaseURL:"https://limpiezapiso-cb761-default-rtdb.europe-west1.firebasedatabase.app",projectId:"limpiezapiso-cb761",storageBucket:"limpiezapiso-cb761.firebasestorage.app",messagingSenderId:"221021062267",appId:"1:221021062267:web:c4327bf470045224534ede",measurementId:"G-WH0M189T28"},Or=ui($h),me=Uh(Or);class Gh{constructor(){this.app=Or,this.db=me,this.path="piso"}insert(e,t){Xs(Oe(me,this.path+e),t)}async initWeek(e){const t=Br(),s=new Date().getFullYear(),i=Oe(me,this.path),r=xr(i,Pr(),Dr(1)),o=await In(r);console.log("snapshot",o);let a=!0;if(o.exists()){const l=Object.values(o.val())[0];console.log(l),l.year==s&&l.week==t&&(a=!1)}if(a){const l=Nh(i);await Xs(l,{year:s,week:t,usuarios:e})}}async listenToUser(e,t){const s=await Js(),i=Oe(me,`piso/${s}/usuarios/${e}`);console.log(i),kh(i,r=>{const o=r.val().done;t(o)})}async toggleDone(e){const t=await Js();if(!t){console.log("❌ No hay registros en la base de datos.");return}const s=Oe(me,`piso/${t}/usuarios/${e}`),i=await In(s);if(!i.exists()){console.log(`❌ El usuario ${e} no existe en el último registro.`);return}const o=!i.val().done;await Rh(s,{done:o})}}const Js=async()=>{const n=Oe(me,"piso"),e=xr(n,Pr(),Dr(1)),t=await In(e);if(t.exists()){const s=t.val(),[i]=Object.keys(s);return i}return null},qh=[new lt("Álvaro"),new lt("Rubén"),new lt("Joan"),new lt("Álex")],Mr=new Fr(qh),K=new Gh,jh=document.querySelector("#alvaroTask"),zh=document.querySelector("#alexTask"),Yh=document.querySelector("#joanTask"),Kh=document.querySelector("#rubiuTask"),Qh=document.querySelector("#diaLabel"),Xh=document.querySelector("#semanaLabel"),Jh=document.querySelector("#alvaroCard"),Zh=document.querySelector("#joanCard"),eu=document.querySelector("#alexCard"),tu=document.querySelector("#rubiusCard"),nu=document.querySelector("#rubiusBorder"),su=document.querySelector("#alvaroBorder"),iu=document.querySelector("#alexBorder"),ru=document.querySelector("#joanBorder"),$t=Mr.getTaskOrder(),ou={usuario0:{nombre:"Rubiu",done:!1},usuario1:{nombre:"Álvaro",done:!1},usuario2:{nombre:"Joan",done:!1},usuario3:{nombre:"Alex",done:!1}};setInterval(K.initWeek(ou),5*60*1e3);Jh.addEventListener("click",async()=>{await K.toggleDone("usuario1")});Zh.addEventListener("click",async()=>{await K.toggleDone("usuario2")});eu.addEventListener("click",async()=>{await K.toggleDone("usuario3")});tu.addEventListener("click",async()=>{await K.toggleDone("usuario0")});K.listenToUser("usuario1",n=>{Gt(su,n)});K.listenToUser("usuario0",n=>{Gt(nu,n)});K.listenToUser("usuario2",n=>{Gt(ru,n)});K.listenToUser("usuario3",n=>{Gt(iu,n)});jh.textContent=$t[1];zh.textContent=$t[3];Yh.textContent=$t[2];Kh.textContent=$t[0];const rs=new Date,au=String(rs.getDate()).padStart(2,"0"),lu=String(rs.getMonth()+1).padStart(2,"0"),cu=rs.getFullYear();Qh.textContent=`DIA: ${au}/${lu}/${cu}`;const hu=Mr.getWeekOfYear();Xh.textContent=`SEMANA: ${hu}`;function Gt(n,e){e?(n.classList.add("from-green-400"),n.classList.add("to-emerald-500"),n.classList.remove("from-red-500"),n.classList.remove("to-red-700")):(n.classList.remove("from-green-400"),n.classList.remove("to-emerald-500"),n.classList.add("from-red-500"),n.classList.add("to-red-700"))}
