    ...
    return (
        ...
        >
            ...
            <div className="flex mt-2 xl:mt-0 flex-col gap-2">
                <h3
                    className="bg-gradient-to-r from-orange-300 to-orange-400  rounded-lg text-2xl font-bold xl:text-xl text-center shadow-md text-gray-800 lato-font"
                >
                    {user.task}
                </h3>
